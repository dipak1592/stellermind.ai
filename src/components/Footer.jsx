...
const data = [
  { country: "in", value: "- A 1602 Privillon, Ambli, BRT Road, Iskcon Cross Rd, Vikram Nagar, Ahmedabad, Gujarat 380059." }, 
  { country: "us", value: "- 16238 Ranch Rd 620 N f 160, Austin, TX 78717, USA." },
    ...
    <footer className="text-[white] bg-[#161515d5] mt-[70px]">
      <div className="lg:py-[50px] pt-[40px] pb-[80px]">
        ...
        duration-300"
              ...
              <Link href={"https://www.guru.com/freelancers/betasourcetech"} target="_blank" rel="noopener"><Image src="/guru.png" alt="" width={80} height={80} /></Link>
              <Link href={"https://clutch.co/profile/betasource-technologies"} target="_blank" rel="noopener"><Image src="/clutch.png" alt="" width={80} height={80} /></Link>
              </div>
            </div>

            <div className="mb-[20px]">
              <h3 className={`text-[20px] text-blue-500 font-semibold mb-[12px]`}>
                Company
              </h3>
            ...
            <div className="mb-[20px]">
              ...
              <div className="text-[17px]">
                ...
                <div className="mb-[5px] hover:text-blue-500 hover:font-semibold">
                  <Link href="/services/augmented-reality">Augmented Reality</Link>
                </div>
                <div className="mb-[5px] hover:text-blue-500 hover:font-semibold">
                ...
                <div className="mb-[5px] hover:text-blue-500 hover:font-semibold">
                  <Link href="/services/custom-software-development">Software Development</Link>
                </div>  
              </div>
            </div>
            <div className="col-span-2 mb-[20px]">
             <h3 className={`text-[20px] text-blue-500 font-semibold mb-[12px]`}>
              ...
              <div className="text-[17px]">
                <div className="mb-[5px] flex gap-2 hover:text-blue-500 hover:font-semibold">
                 ...
                 <FaPhoneAlt className="mt-[4px] " />  </span>
      ...
      />
          ...
          <hr />
          <br />
          <p className="text-center text-[16px]">Copyright © 2023 <Link href="/" className="text-blue-600">StellarMind</Link> . All rights reserved</p>
        </div>
