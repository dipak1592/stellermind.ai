...
async function getData() {
  const res = await fetch(
    `https://ni9c33jq49.execute-api.ap-south-1.amazonaws.com/dev/api/portfolio/getposts?category=mobile`
  );
            ...
            <Link href={`/portfolio/${item.slug}`} className={`${backgroundColor} rounded-xl`} key={item._id}>
              <CardContainer className="inter-var" >
                ...
                >
                  ...
                  <CardItem translateZ="100" className="w-full rounded-lg mt-4">
                    <Image
